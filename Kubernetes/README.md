...
- **Node Port** Mappa una porta associata ad ogni nodo del cluster verso un service
- **Load Balancer** Ha senso nell'ambiiente del public cloud. Nel momento in cui viene creato un service di tipo Load Balancer, il clooud provider andrà a fonire un bilanciatore del traffico (come risorsa del cloud)
